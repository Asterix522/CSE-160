...
function main() {
    ...
    gl.clearColor(0.53, 0.81, 0.98, 1.0); //blue
    gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
    ...
    //ground plane
    let groundPlane = addModel([0.4, 0.7, 0.4], "cube"); //green
    ...
    loadOBJ('assets/carrot.obj', [1.0, 0.5, 0.0], function(model) { //orange color
    carrot = model;
    ...
    loadOBJ('assets/cat.obj', [0.83, 0.83, 0.83], function(model) { //gray color
    cat = model;
